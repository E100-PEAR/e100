...
//
// nested for loop to go through each pixel of the frame
//
...
//
// get pixel color at specified memory address
//
...
//
// set the pixel color at the specified location on the CGA monitor
//
...
//
// outputs a pixel to fix a bug for tiger woods videos 
//                       
...
//
// resets the x_count of the vga screen to 0
//
...
//
// resets the y_count of the vga screen to 0     
//           
...
//
// finishs the analysis (calls keyboard library)
//
