...
//
// reset the low address of the sd card to 0 
// increment the high address by 1
//
...
//
// stop the record function and go to the 
// keyboard library to figure out what to do next
//  
